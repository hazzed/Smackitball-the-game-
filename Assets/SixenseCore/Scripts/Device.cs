    ...
    public class Device : MonoBehaviour
    {
        ...
        public static bool FilterEnabled
        {
            ...
            set
            {
                ...
                Plugin.sxCoreSetFilterEnabled((uint)Filter.MOVING_AVERAGE, value);
            }
        }
        ...
        /// </summary>
        public static MovingAverageFilter FilterSettings
        {
            get
            {
                if (!ms_initialized)
        ...
        public static bool DistortionCorrectionEnabled
        {
            ...
            set
            {
                ...
                Plugin.sxCoreSetFilterEnabled((uint)Filter.IMU_DISTORTION_CORRECTION, value);
            }
        }
		...
		public static bool NetworkBridgeEnabled
		{
			...
			set
			{
				...
				Plugin.sxCoreSetNetworkBridgeEnabled(value);
        ...
        void Awake()
        {
            ...
            if (!ms_globalInitialized)
            {
                ...
                {
                    Debug.Log("Sixense Core Init", gameObject);
        ...
        private partial class Plugin
        {
            ...
            [DllImport(module)]
            public static extern PluginTypes.Result sxCoreSetFilterEnabled(uint filter_type, bool on_or_off);      // enable/disable application controllable filters
            [DllImport(module)]
            public static extern PluginTypes.Result sxCoreGetFilterEnabled(uint filter_type, out bool on_or_off);     // enable/disable application controllable filters
			...
			[DllImport(module)]
			public static extern PluginTypes.Result sxCoreSetNetworkBridgeEnabled( bool on_or_off );
			[DllImport(module)]
			public static extern PluginTypes.Result sxCoreGetNetworkBridgeEnabled( out bool on_or_off );
        }
        #endregion
    }
}
