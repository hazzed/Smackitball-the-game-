...
namespace SixenseCore
{
    ...
    public class Tracker
    {
        ...
        /// </summary>
        public void Vibrate(int milliseconds, float magnitude = 1.0f)
        {
        ...
        internal void ProcessInfo(PluginTypes.TrackedDeviceInfo info)
        {
            ...
            m_Index = info.tracked_device_index;
            ...
            m_hasInfo = (m_HardwareType != Hardware.UNKNOWN);
        }
        ...
        public void Update()
        {
            ...
            m_Connected = Plugin.sxCoreIsTrackedDeviceConnected((uint)m_Index);
        ...
        private TrackerID m_TrackerID = TrackerID.UNKNOWN;
        ...
        private Hardware m_HardwareType = Hardware.UNKNOWN;
        ...
        /// </summary>
        internal Tracker(Device device, int index = -1)
        {
            m_device = device;
            m_Index = index;
        ...
        private partial class Plugin
        {
            ...
            [DllImport(module)]
            public static extern bool sxCoreIsTrackedDeviceConnected(uint tracked_device_index);          // connected and ready to use? (based on status)
