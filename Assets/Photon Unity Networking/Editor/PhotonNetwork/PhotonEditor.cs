...
public class PhotonEditor : EditorWindow
{
    ...
    protected virtual void OnGuiRegisterCloudApp()
    {
        ...
        if (this.photonSetupState == PhotonSetupStates.RegisterForPhotonCloud)
        {
            ...
            if (!InternalEditorUtility.HasAdvancedLicenseOnBuildTarget(BuildTarget.iOS) || !InternalEditorUtility.HasAdvancedLicenseOnBuildTarget(BuildTarget.iOS))
            {
    ...
    protected virtual void OnGuiMainWizard()
    {
        ...
        else if (!InternalEditorUtility.HasAdvancedLicenseOnBuildTarget(BuildTarget.iOS) || !InternalEditorUtility.HasAdvancedLicenseOnBuildTarget(BuildTarget.iOS))
        {
            GUILayout.Label(CurrentLang.MobileExportNoteLabel);
        }
        EditorGUILayout.Separator();
